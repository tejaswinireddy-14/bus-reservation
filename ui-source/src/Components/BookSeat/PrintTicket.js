...
//           </Text>
//           <Text style={styles.travelInfoText}>{searchParams.get('date')}</Text>
//           {/* <Text style={styles.travelInfoText}>{busData.name}</Text> */}
//         </View>
//         {localStorage.getItem('passengerDetails').map((each) => {
//           return (
...
//               <Text style={styles.busDetailText}>
//                 {" "}
//                 {localStorage.getItem('boardingTime')}
//               </Text>
//             </View>
//             <View style={styles.busDetailSubBox}>
...
//               <Text style={styles.busDetailText}>Rs. {searchParams.get('fare')}</Text>
//             </View>
//             <View style={styles.busDetailSubBox}>
...
//                 <View>
//                 <Text style={styles.passengerInfoTextTitle}>Seat Numbers</Text>
//                 <Text style={styles.passengerInfoText}>{localStorage.getItem('seatsBooked')}</Text>
//               </View>
//               </View>
//             </View>
//           </View>
